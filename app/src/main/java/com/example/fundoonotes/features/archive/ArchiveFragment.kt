...
class ArchiveFragment : Fragment(),
    ...
    private fun setupSearchBar() {
        val searchBarFragment = SearchBarFragment.Companion.newInstance("Archive")
    ...
    private fun setupNotesList() {
        notesDisplayFragment = NotesDisplayFragment.Companion.newInstance(NotesGridContext.Archive).apply {
